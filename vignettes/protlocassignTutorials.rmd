...
- name: Dirk F Moore
  affiliation: 
  - Department of Biostatistics and Epidemiology, Rutgers School of Public Health, NJ, US
- name: Peter Lobel
  affiliation: Center for Advanced Biotechnology and Medicine, Rutgers University, NJ, US
date: "`r Sys.Date()`"
...
This set of tutorials provides a comprehensive guide to the `protlocassign` package for constrained proportional assignment. It is available in the package "protlocassigndoc"; details on installing that are given in the next section. Additional details may be found in a companion paper (DF Moore, D Sleat, and P Lobel, 2022).
...
This package implements a subcellular protein assignment procedure known as “constrained proportional assignment”, or CPA (Jadot et al, 2016). The basic concepts involved in CPA and analysis of subcellular proteomics data are described in the main paper (Moore et al., 2022). These tutorials serve as a basis for implementing CPA and various utilities for both experienced and beginner R users.
